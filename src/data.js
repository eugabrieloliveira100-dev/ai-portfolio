...
export const VIDEOS = [
      ...
      {
    id: 'UexKiKd6GU4',
    slug: 'the-haunted-forest',
    categoryId: 'cinematic',
    title: 'The Haunted Forest',
    duration: '0:30',
    aspect: '16/9',
    thumbnail: 'https://img.youtube.com/vi/UexKiKd6GU4/maxresdefault.jpg',
    prompt: 'A wide shot of a young man wearing a red Phrygian mitre on his head, walking tiptoed through a strange and mysterious forest. The camera moves with a travelling shot, keeping deep depth of field so that both the boy and the forest remain sharp. The boy is the main focus, framed by the rule of thirds, positioned on the left vertical third to create visual tension. He wears a sleeveless, worn red shirt that looks ancient and otherworldly, brown leather shorts reaching his knees, and walks barefoot. His skin shows natural pores, his hair is slightly messy, and his eyes reflect both contemplation and unease as he admires the surreal environment.\n\nThe forest is unnerving, dark, with few points of light and vast shadows, evoking the suspense of classic horror such as Nosferatu. The color palette is unnatural: cold blues, sickly greens, deep crimson reds, and heavy purples dominate the space. No natural warmth exists here — the entire scene feels haunted and unreal.\n\nAround him, twisted magical creatures watch from the trees. They are small, with thin, wiry bodies, pale greenish skin stretched tight over bones, and elongated fingers ending in translucent claws. Their heads are oversized, with grotesquely large, glossy eyes set not where human eyes should be, but one pair in the forehead glowing faintly like bioluminescent stones. Their movements are jerky and insect-like, vanishing into shadows as soon as they are noticed. Some cling upside down to the branches like bats, while others crouch, whispering in hushed, inhuman tones.\n\nThe magic of the place is subtle but pervasive: faint particles of light float in the air like drifting ash, trees bend unnaturally as if alive, and shadows seem to stretch longer than they should. At times, faint glows flicker from hollow tree trunks or inside the eyes of the creatures, as if the forest itself was conscious, watching every step. The atmosphere is cinematic, oppressive, and surreal, blending supernatural horror with dreamlike wonder.',
    analysis: 'This prompt relies heavily on precise compositional and chromatic control to evoke psychological dread. By explicitly commanding the "rule of thirds" and placing the subject on the "left vertical third," the prompt artificially injects spatial tension, forcing the viewer\'s eye to scan the heavy negative space on the right. The color grading instructions are incredibly aggressive—expressly forbidding "natural warmth" and demanding a palette of "sickly greens" and "heavy purples." Furthermore, comparing the atmosphere to "classic horror such as Nosferatu" provides the AI with a strong stylistic anchor, ensuring the shadows behave dramatically rather than realistically.'
  },
  {
    id: 'jL_ctnLCFBM',
    slug: 'enchanted-wonderland',
    categoryId: 'world',
    title: 'Enchanted Wonderland',
    duration: '0:30',
    aspect: '16/9',
    thumbnail: 'https://img.youtube.com/vi/jL_ctnLCFBM/maxresdefault.jpg',
    prompt: 'A young man walks slowly through an enchanted yet unsettling forest, reminiscent of a surreal "Alice in Wonderland" world but darker and more mysterious. His gaze drifts nervously from side to side, curiosity and fear coexisting in his expression.\n\nThe young man wears ancient, timeless clothing: a loose linen tunic with slightly frayed edges, a leather belt, and worn boots, his outfit carrying the weight of a world that feels magical and unreal. His skin has natural texture, with visible pores and subtle veins beneath the surface of his hands. His hair is neatly arranged yet slightly tousled by the wind. His eyes shine with a fragile mixture of awe and unease. Every step is measured, hesitant, almost like he is trespassing into the unknown.\n\nThe forest itself looks alive — trees twisted into dreamlike shapes, their bark streaked with impossible colors. Giant mushrooms glow faintly, oversized flowers pulse with faint luminescence, and vines hang in delicate arcs, almost forming natural arches. The ground is layered with roots, moss, and patches of bioluminescent grass. Strange silhouettes shift between the trees, as if the forest itself watches.\n\nUnreal contrasts dominate: some areas intensely illuminated, others swallowed by deep shadow, making the forest appear unstable, as if on the verge of dissolving into dream or nightmare.\n\nVibrant, fantastical tones paint the scene: flashes of electric blue, radiant pink, emerald green, and deep purple highlight plants, stones, and the folds of his clothes.\n\nTheatrical light isolates key elements: a glowing mushroom like a spotlight, or a single flower radiating golden warmth against the darkness.\n\nSubtle halos and magical glows envelop objects and foliage, dust particles and glowing motes drifting in the air like enchanted fireflies.\n\nThe illumination evolves with mood: softer golden hues when he pauses, colder greens and sharp shadows when he turns as if sensing a hidden threat.\n\nLight sources defy realism: mushrooms, floating lanterns, strange glowing eyes in the foliage, all contributing to a world where illumination feels organic and otherworldly.\n\nThe camera drifts fluidly with him, capturing both his apprehensive face and the towering, distorted trees around him. Every frame feels unstable yet hypnotic, as if reality bends with each step, blending wonder and dread.',
    analysis: 'This prompt excels at dynamic, motivated lighting. Instead of a static lighting setup, it instructs the engine to evolve the illumination based on narrative mood—"softer golden hues when he pauses, colder greens... when he turns." The request for "theatrical light" acting as a "spotlight" forces the AI to break physical laws of light diffusion, prioritizing dramatic isolation over realism. Referencing a dark "Alice in Wonderland" instantly establishes a baseline for surreal, disproportionate worldbuilding, giving the AI permission to generate glowing flora and hallucinatory color shifts without losing the high-fidelity rendering of the character\'s physical textures.'
  },
  {
    id: 'pO3jnPd6vZs',
    slug: 'the-monumental-hall',
    categoryId: 'cinematic',
    title: 'The Monumental Hall',
    duration: '0:30',
    aspect: '16/9',
    thumbnail: 'https://img.youtube.com/vi/pO3jnPd6vZs/maxresdefault.jpg',
    prompt: 'The view is a middle shot, with a static camera maintaining visual continuity without cuts.\n\nIt is night: the atmosphere is dark and cold, with subtle fog diffusing through the monumental space. A white man walks slowly, his steps heavy yet deliberate, conveying both fatigue and nobility. He wears white clothes with small blue details, crafted in discreet fabrics that flow naturally with movement. His attire is expensive and antique, transmitting refinement; his distressed leather pants, rustic yet sophisticated, catch beams of light, showing natural cracks and slight wear from time.\n\nHis skin shows natural texture, with visible pores, subtle wrinkles at the eyes and forehead, and a faint shadow of stubble across his jaw. His hair is slightly messy, individual strands catching the side light. His eyes have a faint moist reflection, as if carrying melancholy. His hands are proportional, with well-defined fingers, veins subtly visible under the skin, relaxed posture matching his slow pace.\n\nHe walks through a large, monumental hall where wise men once gathered. The space features colossal golden columns arranged in perfect symmetry, reinforcing order and grandeur. The polished stone floor mirrors the scene diffusely, echoing monumentality and guiding the eye along vanishing lines into the background.\n\nThe composition follows the rule of thirds: the man occupies the left vertical third, offset from the central axis to generate tension and visual intrigue. The depth of field is wide, keeping both the man and the massive architecture in sharp focus, reinforcing the dialogue between character and environment.\n\nThe lighting is antique chiaroscuro: harsh beams of lateral light filter through high windows and hidden apertures, striking the character’s face diagonally, casting long, dramatic shadows on the floor. These alternating bands of brightness and obscurity create rhythm and guide the viewer’s eye toward him.\n\nAround him, golden-armored soldiers stand, their surfaces reflecting light in sharp highlights, contrasting against the darkened backdrop. The leg and knee protectors shimmer, emphasizing the vertical rhythm of the columns. Parchment scrolls rest forgotten in corners, and scattered torches burn discreetly, their flames flickering, offering a secondary warm contrast against the cold, pale light.\n\nMetal produces intense, punctual reflections with sharp highlights that shift as the camera or light source moves. Scratches, dents, and small imperfections in the surface create micro-diffractions, breaking the uniformity and enhancing authenticity. The gold of the soldiers’ armor gleams in crisp flares, while worn edges dull into darker tones, grounding them in use and history.\n\nStone absorbs most of the light, remaining opaque and matte. Its surface texture holds tiny irregularities — cracks, pores, and accumulated dust — that break light unevenly, producing subtle shadows in crevices. The polished stone floor, however, offers diffuse reflections, never perfectly mirror-like, but enough to blur and elongate figures walking across it, adding depth and monumentality.\n\nFabric diffuses light softly, producing delicate gradients across folds. Each type of textile reacts differently: coarse linen scatters light in irregular patches, velvet deepens shadows within folds, and silk catches highlights at sharp angles. The noble garments of the character carry faint signs of wear — frayed hems, creases around joints, faint discoloration from time — grounding opulence in reality.\n\nSkin behaves in complex, layered ways. The outer epidermis shows micro-shadows cast by pores, fine wrinkles, and tiny hairs, while subtle translucency allows light to penetrate and scatter, creating the subsurface scattering effect visible on cheeks, ears, and fingers. Areas of natural moisture — the waterline of the eyes, the lips, the forehead under stress — catch small highlights, adding vitality. The uneven distribution of tone reveals capillaries, faint freckles, healed scars, and slight color variation from sun exposure, anchoring the character in authenticity. The movement of skin over muscle creates tension lines on the neck and around the mouth as he walks, further emphasizing humanity.\n\nHair strands catch light individually, some reflecting sharply, others absorbing, depending on angle. Slight oiliness near the scalp produces tiny glimmers, while dry, loose strands create softer reflections. Stray hairs break symmetry, adding imperfection and realism.\n\nEyes function as micro-lenses, reflecting the environment in distorted miniature. The cornea produces a crisp highlight from the main light source, while the iris scatters light through its radial texture, shifting color subtly. The moist surface creates continuous specular reflection, ensuring they appear alive. Subtle redness at the edges and small veins break artificial smoothness.\n\nHands reveal proportion and humanity: knuckles cast faint shadows, veins raise under the skin, and fingernails reflect dimly with semi-transparent keratin, carrying a slight irregularity in shape and texture. Their relaxed posture conveys the psychology of the moment, as much as the face.\n\nIn the cold air, faint vapor condenses as he exhales, briefly catching the torchlight. The rhythm of shoulders rising and falling, the sway of fabric against the body, and the weight of each step reinforce his humanity, contrasting with the static monumentality of the hall.\n\nThe scene conveys both melancholy and grandeur, capturing the memory of a monumental past while grounding the character in tangible, human imperfection: skin marked by time, breath in the cold air, garments touched by wear, and a presence that feels undeniably alive.',
    analysis: 'This prompt is a staggering masterclass in rendering physics and material definition. Rather than simply describing the visual output, it acts as a literal instruction manual for the AI’s physics engine. By explicitly defining how light must interact with different surfaces—such as instructing "stone absorbs most of the light, remaining opaque," "metal produces intense specular reflections," and "skin allows light to penetrate and scatter"—it completely bypasses the engine\'s default lighting approximations. The microscopic attention to biological realism, detailing the "waterline of the eyes" acting as "micro-lenses," forces the AI to calculate extreme high-fidelity textures. Grounding this highly technical material instruction within an "antique chiaroscuro" lighting setup creates an unparalleled level of photorealism.'
  },
